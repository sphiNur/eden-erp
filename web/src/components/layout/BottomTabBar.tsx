...
export const BottomTabBar = () => {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around items-center h-nav z-nav shadow-[0_-1px_3px_rgba(0,0,0,0.05)]">
            {ADMIN_TABS.map((tab) => {
