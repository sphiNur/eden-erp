    ...
    return (
        <div className="space-y-4 p-3">
            <div className="flex items-center justify-between">
                <h2 className="text-lg font-bold text-foreground">Stall Management</h2>
                <Button
                    size="sm"
            ...
            {showForm && (
                <div className="bg-card rounded-xl border border-border p-4 space-y-3 shadow-sm">
                    <div className="flex justify-between items-center mb-2">
                        <h3 className="font-semibold text-foreground">{editingId ? 'Edit Stall' : 'New Stall'}</h3>
            ...
            <div className="space-y-2">
                {stalls.length === 0 ? (
                    <div className="text-center py-8 text-muted-foreground">
                        ...
                        <p className="text-sm">No stalls yet</p>
                    </div>
                ) : (
                    stalls.map(stall => (
                        <div
